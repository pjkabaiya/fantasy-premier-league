...
A comprehensive React + Vite web application for Fantasy Premier League players to plan strategy, analyze fixtures, and optimize their team for future gameweeks.

---

_Last redeployed: March 2, 2026 (triggered redeploy test)_

## Features

- **Availability Page**: Compares your squad to official Premier League injury updates and shows flags for unavailable players
- **Compare Page**: Compare two players’ stats for a selected range of gameweeks
- **Leagues Page**: Displays all leagues, standings, and gameweek movement
- **Live Page**: Shows live standings and points as the gameweek progresses
- **Team Page**: Shows your current team, player standings, and details
- **Planner Page**: Displays your team and fixtures for the selected gameweek, with chip planning and mock transfer logic
...
- **Availability**: See which of your squad players are flagged as unavailable (injury/suspension) based on official FPL data.
- **Compare**: Select two players and compare their stats for any range of gameweeks.
- **Leagues**: View all your leagues, current standings, and movement from previous gameweeks.
- **Live**: Track your live points and standings as the gameweek progresses.
- **Team**: View your current squad, captain/vice, and player details.
- **Planner**: See your team’s fixtures for any gameweek, plan chips, and make mock transfers.
...
This app is deployed automatically to GitHub Pages via the `gh-pages` branch using GitHub Actions. Any push to `main` triggers a build and deploy.
